...
# класс MirageEditor
class MirageEditor(Frame):
    def __init__(self, parent):
        Frame.__init__(self, parent)
        self.parent = parent
        # Устанавливаем иконку приложения
        self.parent.iconbitmap("MirageLogo.ico")
    ...
    def setUI(self):
        ...
        self.parent.title("MirageEditor")
        ...
        # кнопка ластика
        erase_btn = Button(self, text="Ластик", width=10, command=lambda: self.set_color("white"))
        erase_btn.grid(row=0, column=7)
        # кнопка очистить
...
# вывод справки
def about():
    showinfo("О программе", "Mirage - графический редактор создан на основе потраченных нервов и слёз разработчиков.\nРазработчики: Dimon & Dimentor.\nSo H!gh inc.\n2023 ")
